...
<html lang="en">
    ...
    <body>
        ...
        <section id="brownies" class="background brownies-background py-3">
            <div class="col mx-auto align-items-center my-4">
                <div class="heading text-center">
                    <h3 class="text-light font-weight-bold py-3">Gooey and chewy treats are completely handmade using the finest ingredients.<br>
                         Collect your brownie gift box in-store for free, have our driver's hand deliver to your office or home.
                    </h3>
                </div>
                <div class="container row mx-auto text-center align-items-center justify-content-center mx-5">
                    <?php
                        ...
                        $sql = "SELECT * FROM brownies LIMIT " . $this_page_first_result . ',' . $results_per_page;
                        $result = mysqli_query($conn, $sql);
                    ...
                    ?>
                            <li class="page-item"><a class="page-link" href="brownies.php?page=<?php echo $page?>"><?php echo $page?></a></li>
                    <?php 
                        } 
                    ?>
                        </ul>
